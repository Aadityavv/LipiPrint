...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT new com.lipiprint.backend.dto.OrderListDTO(o.id, u.name, CAST(o.status AS string), o.totalAmount, o.createdAt, o.deliveryType, o.awbNumber, o.courierName, o.trackingUrl, o.expectedDeliveryDate, pAdmin.name, prAdmin.name, cAdmin.name, o.printedAt, o.processedAt, o.completedAt) FROM Order o JOIN o.user u LEFT JOIN o.printedByAdmin pAdmin LEFT JOIN o.processedByAdmin prAdmin LEFT JOIN o.completedByAdmin cAdmin ORDER BY o.createdAt DESC")
    Page<OrderListDTO> findAllForList(Pageable pageable);

    @Query("SELECT new com.lipiprint.backend.dto.OrderListDTO(o.id, u.name, CAST(o.status AS string), o.totalAmount, o.createdAt, o.deliveryType, o.awbNumber, o.courierName, o.trackingUrl, o.expectedDeliveryDate, pAdmin.name, prAdmin.name, cAdmin.name, o.printedAt, o.processedAt, o.completedAt) FROM Order o JOIN o.user u LEFT JOIN o.printedByAdmin pAdmin LEFT JOIN o.processedByAdmin prAdmin LEFT JOIN o.completedByAdmin cAdmin WHERE u.id = :userId ORDER BY o.createdAt DESC")
    Page<OrderListDTO> findAllForListByUser(@Param("userId") Long userId, Pageable pageable);

    @Query("SELECT new com.lipiprint.backend.dto.OrderListDTO(o.id, u.name, CAST(o.status AS string), o.totalAmount, o.createdAt, o.deliveryType, o.awbNumber, o.courierName, o.trackingUrl, o.expectedDeliveryDate, pAdmin.name, prAdmin.name, cAdmin.name, o.printedAt, o.processedAt, o.completedAt) FROM Order o JOIN o.user u LEFT JOIN o.printedByAdmin pAdmin LEFT JOIN o.processedByAdmin prAdmin LEFT JOIN o.completedByAdmin cAdmin WHERE o.status = :status ORDER BY o.createdAt DESC")
    Page<OrderListDTO> findAllForListByStatus(@Param("status") String status, Pageable pageable);

    @Query("SELECT new com.lipiprint.backend.dto.OrderListDTO(o.id, u.name, CAST(o.status AS string), o.totalAmount, o.createdAt, o.deliveryType, o.awbNumber, o.courierName, o.trackingUrl, o.expectedDeliveryDate, pAdmin.name, prAdmin.name, cAdmin.name, o.printedAt, o.processedAt, o.completedAt) FROM Order o JOIN o.user u LEFT JOIN o.printedByAdmin pAdmin LEFT JOIN o.processedByAdmin prAdmin LEFT JOIN o.completedByAdmin cAdmin WHERE u.id = :userId AND o.status = :status ORDER BY o.createdAt DESC")
